...
# ---- carrega apenas o nucleo (tudo antes do marcador da interface) ----------
AQUI = os.path.dirname(os.path.abspath(__file__))
fonte = open(os.path.join(AQUI, "app.py"), encoding="utf-8").read()
corte = fonte.index("# S10 - INTERFACE STREAMLIT")
corte = fonte.rindex("# ====", 0, corte)
NUCLEO = {}
exec(compile(fonte[:corte], "app.py", "exec"), NUCLEO)
g = NUCLEO
